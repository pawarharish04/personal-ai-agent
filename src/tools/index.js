...
const toolsRegistry = {
  ...
  gmail_list_messages: {
    schema: {
      ...
      description: 'List or search user emails from Gmail.',
      input_schema: {
        type: 'object',
        properties: {
          query: { type: 'string', description: 'Search query e.g. "is:unread", "from:example@domain.com", or keyword' },
          maxResults: { type: 'number', description: 'Max number of messages to return (default 5, max 20)' }
        }
      }
    },
    risky: false,
